...
'''
0 worker: num_workers=0, no checkpoint, FP32
'''
...
torch.save(model.state_dict(), "model_history/resnext_0_worker.pt")
np.savez("model_history/resnext_0_worker.npz", loss=training_loss, acc=training_acc, test_acc=testing_acc)
